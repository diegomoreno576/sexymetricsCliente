    ...
    <div className="TeamContainer">
      <div className="notecopiesLogo">
        <div className="notecopiesLogoimg">
          <img
            src={stateApp.darkmode ? "https://notecopies.es/wp-content/uploads/2021/03/notecopies-blanco.gif" : "https://notecopies.es/wp-content/uploads/2021/12/notecopies-azul_firma_correo.gif"}
            alt=""
          />
        </div>
      </div>
